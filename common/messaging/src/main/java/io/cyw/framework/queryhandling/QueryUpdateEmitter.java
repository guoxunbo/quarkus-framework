 ...
 * lifecycle of the current {@link io.cyw.framework.messaging.unitofwork.UnitOfWork} to ensure correct order of
 * execution.
 * <p>
 * Added, implementations of this class should thus respect any current UnitOfWork in the {@link
 * io.cyw.framework.messaging.unitofwork.UnitOfWork.Phase#STARTED} phase for any of the emitting functions. If this is
 * the case then the emitter call action should be performed during the {@link io.cyw.framework.messaging.unitofwork.UnitOfWork.Phase#AFTER_COMMIT}.
